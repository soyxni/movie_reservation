...
from .views import SeatReservationView, ReservationListView, ReservationCancelView, ShowtimeSeatsView, ReservationDetailsView
...
urlpatterns = [
    ...
    path('<int:pk>/', ReservationDetailsView.as_view(), name='reservation-details'),  # 예약 상세
]
